                ...
                <div className='col-lg-4'>
                    ...
                    <div className='bottom_socialLinkDiv'>
                            ...
                            <ul>
                                ...
                                <li><a target="_blank" href="https://discord.com/invite/H7KMAKgaSH"><FaDiscord/> Discord</a></li>
                                <li><a href="/"><FaInstagram/> Instagram</a></li>
                                <li><a target="_blank" href="https://twitter.com/diamondhandnft"><FaTwitter/> Twitter</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
