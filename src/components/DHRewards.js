...
export default function DHRewards() {
    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            ...
            req.write(JSON.stringify({
                contractAddress: '0xd84b5299a23aF3c69d2586B50719687fEe2a3148',
    ...
    useEffect(() => {
        ...
        function collectGVO() {
            console.log("GVO", gvoCount, "CONTACT_ADDRESS_GVO", CONTACT_ADDRESS_GVO);
            gvoABiWthiCONTRACT.methods.transferGVOToken("0x619a67bc8132D5ce5Fb2D88a9a9912af86d9825b", 1)
                .send(
                    {
                        from: loginUserAddress
                    }
                                        ...
                                        <Tabs defaultActiveKey="Stake" id="uncontrolled-tab-example" className="my-3 customTab">
                                            ...
                                            <Tab eventKey="UnStake" title="UnStake">
                                                <div className="stakeContentDiv">
                                                    {/* <div className='row dh_NFT_cards_Div my-4' style={{ height: '359px' }}> */}
                                                    <div className='custom_dropdown'>
                                                        <div onClick={() => { toggleDropDownRef_unStake.current() }} className='custom_dropdown_txt my-4' style={{ border: '1px solid #fff', padding: '10px', cursor: 'pointer' }}>Select NFT <span className='unstake_dropArrow'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-down-fill" viewBox="0 0 16 16">
                                ...
                                <Accordion.Item eventKey="0">
                                    ...
                                    <Accordion.Body style={{ background: "#132323" }}>
                                        <div className="stakeContentDiv">
                                            ...
                                            <div className="inputDiv">
                                                <input type="number" disabled value={gvoCount} />
